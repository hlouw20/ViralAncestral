...
library(phytools)
setwd("~/Desktop/ViralAncestral/unused_files/results/5UTR_Trees/GTR+F+I+G4/GTR+I+G4 IRES 1 Ancestral with Mitovirus Outgroup")
...
muscle_gtr_5utr_nt_ires1_rooted <- root(muscle_gtr_5utr_nt_ires1, outgroup = "Ophiostoma_mitovirus_4", node.lables = "support")
