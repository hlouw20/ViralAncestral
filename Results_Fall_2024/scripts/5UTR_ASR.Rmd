...
Directory: `cd /Users/haileylouw/Desktop/ViralAncestral/Results_Fall_2024/5-UTR`
...
Read-in data to remove commas (incompatible with RAxML): 

```{r fix data}
ires1_rep_nt <- read.fasta("/Users/haileylouw/Desktop/ViralAncestral/Results_Fall_2024/Replicase_Gene/GTR+I+G4/ires1_REP_NT_with_outgroup_aligned.fasta")
ires1_rep_aa <- read.fasta("/Users/haileylouw/Desktop/ViralAncestral/Results_Fall_2024/Replicase_Gene/LG+F+I+G4/ires1_REP_AA_with_outgroup_aligned.fasta")

# remove all commas, paretheses, and spaces
ires1_rep_nt$seq.name <-  gsub("[,() ]", "", ires1_rep_nt$seq.name)
ires1_rep_aa$seq.name <-  gsub("[,() ]", "", ires1_rep_aa$seq.name)

dat2fasta(ires1_rep_nt, "/Users/haileylouw/Desktop/ViralAncestral/Results_Fall_2024/Replicase_Gene/GTR+I+G4/ires1_REP_NT_with_outgroup_aligned.fasta")

dat2fasta(ires1_rep_aa, "/Users/haileylouw/Desktop/ViralAncestral/Results_Fall_2024/Replicase_Gene/LG+F+I+G4/ires1_REP_AA_with_outgroup_aligned.fasta")
```
